...
function info () {
    ...
    for (let i = 0; i < objArr.length; i++) {
        ...
        avgForAllDept = totalForAllDept / 4 ;
...
//
   ...
   //  
    ...
    let tdEleFooter3 = document.createElement("td");
    tdEleFooter3.textContent = totalEmp;
    trAllDept.appendChild(tdEleFooter3);

    let tdEleFooter = document.createElement("td");
    tdEleFooter.textContent = totalForAllDept;
